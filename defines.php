...
function content_scroller_get_current_nav_type()
{
    ...
    if ( ! array_key_exists( $type, content_scroller_get_nav_types() ) ) {
        $type = null;
    }
...
{
    return array(
        CONTENT_SCROLLER_NAV_TYPE_NUMBER => 'Post Number on Page',
        CONTENT_SCROLLER_NAV_TYPE_DATE   => 'Date of Post',
